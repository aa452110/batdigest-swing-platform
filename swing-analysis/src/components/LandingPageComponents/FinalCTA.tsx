  ...
  <section className="py-20 bg-gradient-to-br from-slate-900 via-teal-800 to-teal-600 text-white">
    <div className="max-w-5xl mx-auto text-center px-4">
      ...
      <div className="flex gap-4 justify-center flex-wrap">
        <a href="#pricing" className="inline-block bg-cyan-500 text-white px-10 py-5 rounded-lg font-bold text-xl hover:bg-cyan-600 transform hover:-translate-y-1 transition-all">Join as Player</a>
