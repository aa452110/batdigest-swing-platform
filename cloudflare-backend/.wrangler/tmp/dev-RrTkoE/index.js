...
// .wrangler/tmp/bundle-1vCIof/checked-fetch.js
...
async function handleSignup(request, env, corsHeaders) {
  ...
  try {
    ...
    const emailTemplate = emailTemplates.welcome(firstName, planType || "Starter");
    const emailSent = await sendEmail({
      to: email,
      from: "noreply@batdigest.com",
...
// .wrangler/tmp/bundle-1vCIof/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1vCIof/middleware-loader.entry.ts
